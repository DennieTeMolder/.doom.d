...
| Activate | oc-basic       | oc-basic     | oc-basic     |
...
#+BEGIN_src emacs-lisp
(setq! bibtex-completion-library-path '("/path/to/Papers/")
       bibtex-completion-notes-path "/path/to/your/notes/")
#+END_src

#+BEGIN_src emacs-lisp
(setq! bibtex-actions-library-path '("/path/to/Papers/")
       bibtex-actions-notes-path "/path/to/your/notes/")
#+END_src
